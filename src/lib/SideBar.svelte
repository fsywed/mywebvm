<script>
 	...
 	const icons = [
 		{ icon: 'fas fa-info-circle', info: '信息', activity: null },
 		{ icon: 'fas fa-wifi', info: '网络', activity: null },
 		{ icon: 'fas fa-microchip', info: 'CPU', activity: cpuActivity },
 		{ icon: 'fas fa-compact-disc', info: '磁盘', activity: diskActivity },
 		{ icon: 'fas fa-robot', info: 'ClaudeAI', activity: aiActivity },
 		null,
 		{ icon: 'fas fa-book-open', info: '文章', activity: null },
 	...
 	>
 		<div class="absolute right-2 top-2">
 			<SmallButton
 				...
 				buttonTooltip={sideBarPinned ? "取消固定" : "固定侧边栏"}
